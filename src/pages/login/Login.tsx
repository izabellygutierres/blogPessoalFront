    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 h-screen place-items-center font-bold">
            <form className="flex justify-center items-center flex-col w-1/2 gap-4" onSubmit={login}>
                ...
                <button
                    type='submit'
                    className="rounded bg-rose-400 flex justify-center hover:bg-rose-900 text-white w-1/2 py-2">
                ...
                <p>
                    ...
                    <Link to="/cadastro" className="text-rose-800 hover:underline">Cadastre-se</Link>
                </p>
            </form>
